...
public class Main {
	...
	public static void main(String[] args){
		...
		input.add(new InputDataUnit(14, 22, "Entity"));
		input.add(new InputDataUnit(0, 5, "Entity"));
		input.add(new InputDataUnit(56, 67, "Twitter username"));
		input.add(new InputDataUnit(37, 54, "Link"));
